#' @title Query a Grid with png as Output Format
#'
#' @description
#' Retrieve a grid from the Meteomatics Weather API and save it as png file
#'
#' @param filename A string specifying the directory and filename of
...
#' @param ens_select A string containing the ensembles of interest. The
...
#'
#' @return A png image of the queried grid.
#'
#' @export
#'
#' @import lubridate
